  ...
  return (
    <div className="min-h-screen pt-24 pb-16 bg-gradient-to-b from-background to-muted/30">
      <div className="container mx-auto px-4">
        ...
        >
          {[
            { label: 'Total Contributors', value: '-', icon: Users },
            { label: 'Contributions Today', value: '-', icon: Award },
            { label: 'Languages Covered', value: '-', icon: Trophy },
            { label: 'Quality Score', value: '-', icon: Medal },
          ].map((stat, index) => (
            <div
              key={stat.label}
        ...
        {filteredContributors.length === 0 && (
          <motion.div
            ...
            className="bg-card rounded-2xl border border-border p-12 text-center shadow-soft"
          >
            <Trophy className="w-16 h-16 mx-auto mb-4 text-muted-foreground/50" />
            <h3 className="text-xl font-semibold mb-2">No contributors yet</h3>
            <p className="text-muted-foreground">Be the first to contribute and appear on the leaderboard!</p>
          </motion.div>
        )}
                    ...
                    >
                      ...
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-3">
                          <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-primary/20 to-primary-light/20 flex items-center justify-center font-semibold text-primary">
